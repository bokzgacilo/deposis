<?php
  ...
  switch($condition){
    case 'fromA':
      $sql = "SELECT * FROM approved ORDER BY title ASC";
      break;
    case 'fromZ':
      $sql = "SELECT * FROM approved ORDER BY title DESC";
      break;
    case 'Newest':
      $sql = "SELECT * FROM approved ORDER BY publication_date DESC";
      break;
    case 'Oldest':
      $sql = "SELECT * FROM approved ORDER BY publication_date ASC";
      break;
  }
